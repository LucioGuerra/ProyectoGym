...
import {Activity, ToolbarComponent} from "../../components";
...
@Component({
  selector: 'app-shif-client-screen',
  standalone: true,
  ...
  templateUrl: './shif-client-screen.component.html',
  providers: [provideNativeDateAdapter()],
  styleUrl: './shif-client-screen.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ShifClientScreenComponent {
  public activities = [{
    name: 'Crossfit',
  },
    {
  ...
  constructor(private auth0: AuthService, private router: Router) {
    effect(() => {
      if(this.auth0.isAuthenticated()){
        ...
        this.router.navigate(['/client/agenda']);
      }
      else{
